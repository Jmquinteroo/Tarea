    ...
    <div class="col-md-10">
        <form action="{{ route('registrostore') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group text-center">
                        <input type="text" name="cedula" class="form-control" placeholder="CC" required
                               autofocus>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="form-group text-center">
                        <input type="text" name="placa" class="form-control" placeholder="placa" required autofocus>
                    </div>
                </div>
